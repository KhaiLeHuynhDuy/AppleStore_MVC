!function (t) {
        ...
        t.exports = class {
            ...
            update(t, e, s) {
                this.target = t[0] + e * (t[1] - t[0]),
                    ...
                    this.current += (this.target - this.current) * s;
                let i = this.delta(this.current, this.target);
                return i < this.epsilon && (this.current = this.target,
                    i = 0),
                    i > this.epsilon || 0 === i && this.previousValue !== this.current
            }
            reconcile(t, e) {
    ...
    , function (t, e, s) {
        "use strict";
        var i, r = s(34).EventEmitterMicro, n = s(35), o = s(38);
        function a(t) {
            t = t || {},
                r.call(this),
                this.id = o.getNewID(),
    ...
    , function (t, e, s) {
        ...
        n.requestAnimationFrame = function (t) {
            return this.events[t] || (this.events[t] = new i(t)),
    ...
    , function (t, e, s) {
        ...
        const i = s(0)
            ...
            , m = s(20)
            , p = s(22)
            , { cssAttributes: d, suffixFreeAttributes: f, domAttributes: g } = s(23);
        class _ {
            constructor(t, e) {
                this.controller = t,
                    this.anchors = [],
                    ...
                    this.isEnabled = !1,
                    this.animValues = {},
                    this.breakpointMask = i.KeyframeDefaults.breakpointMask,
                    this.disabledWhen = [],
                    this.keyframeType = i.KeyframeTypes.Interpolation,
                    this.hold = !1,
            ...
            parseOptions(t) {
                this.jsonProps = t,
                    ...
                    "" !== t.anchors && t.anchors ? (this.anchors = [],
                        ...
                        t.anchors.forEach((e, s) => {
                            let i = c(e, this.controller.group.element);
                            if (!i) {
                                let i = "";
                                return "string" == typeof e && (i = " Provided value was a string, so a failed attempt was made to find anchor with the provided querystring in group.element, or in the document."),
                                    void console.warn("Keyframe on", this.controller.element, ` failed to find anchor at index ${s} in array`, t.anchors, ". Anchors must be JS Object references, Elements references, or valid query selector strings. " + i)
                            }
                            this.anchors.push(i),
                                this.controller.group.metrics.add(i)
                        }
                        )) : (this.anchors = [],
                            t.anchors = []),
                    ...
                    t.easeFunction || (t.easeFunction = i.KeyframeDefaults.easeFunctionString),
                    ...
                    t.hasOwnProperty("preserveState") ? this.preserveState = t.preserveState : t.preserveState = i.KeyframeDefaults.preserveState,
                    this.easeFunction = a[t.easeFunction],
                    a.hasOwnProperty(t.easeFunction) || (t.easeFunction.includes("bezier") ? this.easeFunction = h.fromCSSString(t.easeFunction) : t.easeFunction.includes("spring") ? this.easeFunction = l.fromCSSString(t.easeFunction) : console.error("Keyframe parseOptions cannot find 'easeFunction' named '" + t.easeFunction + "'"));
                for (let e in t) {
                    if (-1 !== i.KeyframeJSONReservedWords.indexOf(e))
                        continue;
                    let s = t[e];
                    if (Array.isArray(s)) {
                        if (1 === s.length && (s[1] = s[0],
                            ...
                            if (!l && this.controller._ownerIsElement)
                                if (a || d.includes(e)) {
                                    ...
                                    o = parseFloat(this.controller.getTargetComputedStyle().getPropertyValue(s)),
                                        isNaN(o) && (o = 0),
                                        l = new n(o, i.KeyframeDefaults.epsilon, this.snapAtCreation, e, r, h),
                                        this.controller.cssAttributes.push(l)
                                } else
                                    g.includes(e) && (l = new r(o, i.KeyframeDefaults.epsilon, this.snapAtCreation, e, t.round, h),
                                        this.controller.domAttributes.push(l));
                            l || (l = new r(o, i.KeyframeDefaults.epsilon, this.snapAtCreation, e, t.round, h)),
                                this.controller.tweenProps[e] = l
                        }
                        this.animValues[e] = this.controller.group.expressionParser.parseArray(this, s),
                            this.controller.tweenProps[e].calculateEpsilon(t, this.animValues[e])
                    }
                }
                this.keyframeType = this.hold ? i.KeyframeTypes.InterpolationForward : i.KeyframeTypes.Interpolation,
            ...
            setEnabled(t) {
                ...
                let e = -1 !== this.breakpointMask.indexOf(i.pageMetrics.breakpoint)
                    , s = !1;
                return this.disabledWhen.length > 0 && (s = this.disabledWhen.some(e => void 0 !== t[e])),
                    this.isEnabled = e && !s,
                    this.isEnabled
            }
            evaluateConstraints() {
    ...
    , function (t, e) {
        class s {
            ...
            off(t, e) {
                ...
                const s = this._events[t].indexOf(e);
                -1 !== s && this._events[t].splice(s, 1)
            }
            trigger(t, e) {
                if (this.has(t))
                    for (let s = this._events[t].length - 1; s >= 0; s--)
                        void 0 !== e ? this._events[t][s](e) : this._events[t][s]()
            }
            has(t) {
    ...
    , function (t, e, s) {
        ...
        class o extends i {
            ...
            parseOptions(t) {
                ...
                i.prototype.parseOptions.call(this, t),
    ...
    , function (t, e, s) {
        ...
        const i = s(8)
            ...
            , m = s(49)
            , p = {};
        "undefined" != typeof window && (p.create = s(3),
            p.update = s(4),
            p.draw = s(6));
        let d = 0;
        t.exports = class extends i {
            ...
            removeKeyframeController(t) {
                return t.destroyed || !this.keyframeControllers.includes(t) ? Promise.resolve() : (t._allKeyframes.forEach(t => t.markedForRemoval = !0),
                    ...
                    new Promise(e => {
                        p.draw(() => {
                            const s = this.keyframeControllers.indexOf(t);
                            -1 !== s ? (this.keyframeControllers.splice(s, 1),
                                t.onDOMWrite(),
                                t.destroy(),
            ...
            addKeyframe(t, e) {
                ...
                return null === s && (s = new m(this, t),
                    this.keyframeControllers.push(s)),
                    this.keyframesDirty = !0,
                    s.addKeyframe(e)
            }
            addEvent(t, e) {
                ...
                return s ? (e.onEnterOnce && i.controller.once(e.event + ":enter", e.onEnterOnce),
            ...
            determineActiveKeyframes(t) {
                ...
                for (let e = 0, s = this.keyframeControllers.length; e < s; e++)
            ...
            updateBounds() {
                ...
                s - e < o.pageMetrics.windowHeight ? (t.min = this.convertScrollPositionToTValue(e - .5 * o.pageMetrics.windowHeight),
                    t.max = this.convertScrollPositionToTValue(s + .5 * o.pageMetrics.windowHeight)) : (t.min -= .001,
                        t.max += .001),
            ...
            updateTimeline(t) {
                ...
                if (!this.timelineUpdateRequired && e && s && this.position.lastPosition === t)
                ...
                (n || o) && (this.performTimelineDispatch(),
                    this.requestDOMChange(),
    ...
    , function (t, e, s) {
        ...
        t.exports = class extends i {
            ...
            addDiscreteEvent(t) {
                ...
                return e ? (t.onEnterOnce && s.controller.once(t.event + ":enter", t.onEnterOnce),
            ...
            addRAFLoop(t) {
                ...
                s.on("update", t.onUpdate || n),
                    s.on("draw", t.onDraw || n),
                    s.on("draw", () => s.run());
                const { onEnter: i, onExit: o } = t;
                return t.onEnter = () => {
                    s.run(),
                        i && i()
                }
    ...
    , function (t, e, s) {
        ...
        r.on = function (t, e) {
            ...
            r.off = function (t, e) {
                ...
                let s = this._events[t].indexOf(e);
                -1 !== s && this._events[t].splice(s, 1)
            }
            ,
        ...
        class o extends i {
            ...
            updateLocalProgress(t) {
                if (this.hasDuration) {
                    ...
                    if (e === s)
                        return;
                    return this.isCurrentlyInRange = s,
                        void (s && !e ? this._trigger(this.event + ":enter") : e && !s && this._trigger(this.event + ":exit"))
                }
        ...
        t.exports = class {
            ...
            add(t) {
                ...
                if (e)
                    return e;
                let s = new n(t);
                return this._metrics.set(t, s),
                    this._refreshMetrics(t, s)
            }
            get(t) {
            ...
            _refreshMetrics(t, e) {
                ...
                if (void 0 === t.offsetWidth) {
                    ...
                    return e.width = s.width,
                        e.height = s.height,
                        e.top = i.pageMetrics.scrollY + s.top,
                        e.left = i.pageMetrics.scrollX + s.left,
                        e.right = e.left + e.width,
                        e.bottom = e.top + e.height,
                        e
                }
                e.width = t.offsetWidth,
                    ...
                    e.top = i.pageMetrics.documentOffsetY,
                    e.left = i.pageMetrics.documentOffsetX;
                let s = t;
                for (; s;)
                    e.top += s.offsetTop,
                        e.left += s.offsetLeft,
    ...
    , function (t, e, s) {
        ...
        t.exports = class extends i {
            ...
            update(t, e, s) {
                for (let i = 0, r = this.target.length; i < r; i++)
                    this.target[i] = t[0][i] + e * (t[1][i] - t[0][i]),
                        this.previousValue[i] = this.current[i],
                        this.current[i] += (this.target[i] - this.current[i]) * s;
                let i = this.delta(this.current, this.target);
                return i < this.epsilon && (this.current = new Float32Array(this.target),
                    i = 0),
                    i > this.epsilon || 0 === i && this.previousValue.some((t, e) => t !== this.current[e])
            }
            reconcile(t, e) {
                return this.initialValue.forEach((e, s) => this.initialValue[s] = t[0][s]),
                    this.update(t, e, 1)
            }
            needsUpdate() {
                return this.delta(this.current, this.target) > this.epsilon
        ...
        t.exports = class {
            ...
            addChapter(t) {
                ...
                if (this.chapters.push(n),
                    s) {
                    if (this.chapterNames.hasOwnProperty(s))
                        throw ReferenceError(`Duplicate chapter name assigned - "${s}" is already in use`);
            ...
            playToChapter(t) {
                ...
                return this.tween = this.timeGroup.anim.addTween({
                    ...
                    onDraw: t => {
                        ...
                        this.timeGroup.time(s),
                            t.keyframe.curvedT > .5 && !a && (a = !0,
                                this.currentIndex = e.index,
                                this.currentChapter = e,
                                this.timeGroup.trigger(i.EVENTS.ON_CHAPTER_OCCURRED, {
                                    player: this,
                                    current: e
                                }))
                    }
        ...
        class a extends i {
            constructor(t, e = {}) {
                ...
                super(),
                    ...
                    this.attribute = this.componentAttribute.replace(/-./g, t => t[1].toUpperCase()).replace(/data(.)/, (t, e) => e.toLowerCase()),
                    this.components = [],
            ...
            addComponent(t) {
                const { el: e, componentName: s, data: i } = t;
                if (!n.hasOwnProperty(s))
                    throw "BubbleGum::addComponent could not add component to '" + e.className + "'. No component type '" + s + "' found!";
                const r = n[s];
                if (!a.componentIsSupported(r, s))
                    return void 0 === o[s] && (console.log("BubbleGum::addComponent unsupported component '" + s + "'. Reason: '" + s + ".IS_SUPPORTED' returned false"),
                        o[s] = !0),
                        null;
            ...
            removeComponent(t) {
                ...
                -1 !== e && (this.components.splice(e, 1),
                    t.el.dataset[this.attribute] = t.el.dataset[this.attribute].split(" ").filter(e => e !== t.componentName).join(" "),
                    t.destroy())
            }
            ...
            static componentIsSupported(t, e) {
                ...
                return void 0 === i ? (console.error('BubbleGum::addComponent error in "' + e + '".IS_SUPPORTED - it should be a function which returns true/false'),
                    !0) : i
            }
        }
        a.EVENTS = {
            ...
            add: function (t) {
                ...
                const a = () => {
                    ...
                    if (e !== t)
                        ...
                        o >= this.NUMBER_OF_FRAMES_TO_WAIT)
    ...
    , function (t, e, s) {
        "use strict";
        var i, r = "undefined" != typeof window ? window : {}, n = r.AC, o = (i = {},
        {
            get: function (t, e) {
                var s = null;
                return i[t] && i[t][e] && (s = i[t][e]),
                    s
            },
            set: function (t, e, s) {
                return i[t] || (i[t] = {}),
                    i[t][e] = "function" == typeof s ? new s : s,
                    i[t][e]
            },
            share: function (t, e, s) {
                var i = this.get(t, e);
                return i || (i = this.set(t, e, s)),
                    i
            },
            remove: function (t, e) {
                var s = typeof e;
    ...
    , function (t, e, s) {
        ...
        const i = s(8)
            ...
            , c = s(64)
            , m = {};
        "undefined" != typeof window && (m.update = s(4),
            m.cancelUpdate = s(65),
            m.external = s(27),
            m.draw = s(6));
        let p = null;
        class d extends i {
            ...
            createTimeGroup(t, e) {
                ...
                let s = new l(t, this);
                return e && e.name && (s.name = e.name),
                    this.groups.push(s),
                    this.timeSystems.push(s),
                    this.trigger(r.EVENTS.ON_GROUP_CREATED, s),
                    s
            }
            createScrollGroup(t, e) {
                ...
                let s = new h(t, this);
                return (e = e || {}).name && (s.name = e.name),
                    e.getPosition && e.getMaxPosition && (s.getPosition = e.getPosition,
                        s.createViewableRange = () => ({
                            a: 0,
                            d: e.getMaxPosition()
                        })),
                    s.getPosition = e.getPosition || s.getPosition,
                    s.getPosition = e.getPosition || s.getPosition,
                    this.groups.push(s),
                    this.scrollSystems.push(s),
                    this.trigger(r.EVENTS.ON_GROUP_CREATED, s),
                    s
            }
            removeGroup(t) {
            ...
            onResizeImmediate() {
                ...
                r.pageMetrics.documentOffsetX = s.left + r.pageMetrics.scrollX,
                    r.pageMetrics.documentOffsetY = s.top + r.pageMetrics.scrollY,
                    window.clearTimeout(r.RESIZE_TIMEOUT),
            ...
            addKeyframe(t, e) {
                ...
                return s = s || this.getGroupForTarget(document.body),
                    s.addKeyframe(t, e)
            }
            addEvent(t, e) {
                let s = this.getGroupForTarget(t);
            ...
            _getGroupForTarget(t, e) {
                ...
                let s = t;
                for (; s;) {
                    if (s._animInfo && s._animInfo.isGroup && e(s._animInfo.group))
                        return s._animInfo.group;
                    s = s.parentElement
                }
            }
            getControllerForTarget(t) {
        ...
        t.exports = "undefined" == typeof window ? new d : window.AC.SharedInstance.share("AnimSystem", c.major, d),
        ...
        class r {
            constructor(t, e, s, i) {
                this.cp = new Float32Array(6),
                    this.cp[0] = 3 * t,
                    this.cp[1] = 3 * (s - t) - this.cp[0],
                    this.cp[2] = 1 - this.cp[0] - this.cp[1],
                    this.cp[3] = 3 * e,
                    this.cp[4] = 3 * (i - e) - this.cp[3],
        ...
        class n {
            ...
            parseExpression(t, e) {
                ...
                return this.data.target = t.controller.element,
                    ...
                    this.group.anim.plugins.parser.reduce((s, i) => s || i.parseExpression.call(this, t, e), null) || n._parse(e, this.data)
            }
            parseTimeValue(t, e) {
                if ("number" == typeof e)
                    return e;
    ...
    , function (t, e, s) {
        ...
        Object.getOwnPropertyNames(Math).forEach(t => a[t] ? null : a[t.toLowerCase()] = Math[t]),
            Object.getOwnPropertyNames(r).forEach(t => a[t] ? null : a[t.toLowerCase()] = r[t]),
            Object.getOwnPropertyNames(n).forEach(t => a[t] = n[t]);
        let h = null;
        const l = "a"
            , u = "ALPHA"
            , c = "("
            ...
            , w = function (t, e, s, i = "") {
                ...
                throw console.error(n.message, h ? h.keyframe || h.target : ""),
                n
            }
            , x = {
                round: 1,
        ...
        class C extends A {
            constructor(t, e) {
                if (super("MathOp"),
                    ...
                    throw new Error(`Incorrect number of arguments for '${t.value}'. Received ${e.length}, expected ${x[t.value]}`)
            }
        }
        class I extends A {
            constructor(t) {
        ...
        class k {
            constructor(t) {
                ...
                for (this.text = t,
                    ...
                    this.tokens = []; (e = this.getNextToken()) && e !== T.EOF;)
                    this.tokens.push(e);
                this.tokens.push(e)
            }
            advance() {
            ...
            number() {
                ...
                return "." === t && w("Attempted to parse a number, but found only a decimal point", this.text, this.pos),
                    t.includes(".") ? new T(y, parseFloat(t)) : new T(_, parseInt(t))
            }
            getNextToken() {
                for (; null != this.char;)
        ...
        class F {
            ...
            factor() {
                if (this.currentToken.type === p)
                    return new P(this.consume(p), this.factor());
                if (this.currentToken.type === d)
                    return new P(this.consume(d), this.factor());
                if (this.currentToken.type === _ || this.currentToken.type === y) {
                    let t = new I(this.currentToken);
                    if (this.pos += 1,
                        E.OPERATOR.test(this.currentToken.value) || this.currentToken.type === m || this.currentToken.type === b || this.currentToken.type === v)
                        return t;
                    if (this.currentToken.type === u && this.currentToken.value === l)
                    ...
                    if (E.OBJECT_UNIT.test(this.currentToken.value))
                        return new O(new I(T.ONE), null, this.unit());
                    if (this.currentToken.value === l) {
                        this.consume(u);
                        const t = this.anchorIndex();
                        if (E.OBJECT_UNIT.test(this.currentToken.value))
                            return new O(new I(T.ONE), t, this.unit())
            ...
            unit(t = E.ANY_UNIT) {
                const e = this.currentToken;
                if (e.type === u && t.test(e.value))
                    return this.consume(u),
                        new T(u, e.value = e.value.replace(/%(h|w)/, "$1").replace("%", "h"));
        ...
        class D {
            ...
            unwrapReference(t) {
                return null === t.ref ? h.target : (t.ref.value >= h.anchors.length && console.error("Not enough anchors supplied for expression " + this.parser.lexer.text, h.target),
                    h.anchors[t.ref.value])
            }
            execute(t) {
                return h = t,
    ...
    , function (t, e, s) {
        ...
        const i = s(0)
            ...
            , m = s(52)
            , p = {};
        "undefined" != typeof window && (p.update = s(4),
            p.external = s(27),
            p.draw = s(6));
        const { transformAttributes: d, cssAttributes: f, domAttributes: g } = s(23)
            , _ = s(53)
            , y = s(9)
            , b = s(54)
            , v = Math.PI / 180
        ...
        t.exports = class extends c {
            ...
            updateCachedValuesFromElement() {
                ...
                ["x", "y", "z"].forEach((t, e) => {
                    ...
                    this.tweenProps.rotation = new r(s.rotation[2], n, !1, "rotation"),
                    ["rotationX", "rotationY", "rotationZ"].forEach((t, e) => {
                        this.tweenProps[t] = new r(s.rotation[e], n, !1, t)
                    }
                    ),
                    this.tweenProps.scale = new r(s.scale[0], n, !1, "scale"),
            ...
            addKeyframe(t) {
                ...
                let s = new e(this, t);
                return s.parseOptions(t),
                    s.id = this._allKeyframes.length,
                    this._allKeyframes.push(s),
                    s
            }
            needsUpdate() {
            ...
            reconcile() {
                for (let t = 0, e = this.attributes.length; t < e; t++) {
                    ...
                    s.updateLocalProgress(this.group.position.local),
                        s.snapAtCreation && s.reconcile(e)
                }
            }
            determineActiveKeyframes(t) {
                ...
                for (let e = 0; e < this._allKeyframes.length; e++) {
                    ...
                    if (s.markedForRemoval || s.hidden || !s.setEnabled(t))
                        for (let t in s.animValues)
                            this.tweenProps[t].isActive = s.preserveState,
                                s.preserveState && (i[t] = !0);
                    else {
                        this._activeKeyframes.push(s);
                        for (let t in s.animValues)
                            this.keyframes[t] = this.keyframes[t] || [],
                                this.keyframes[t].push(s),
                                -1 === this.attributes.indexOf(t) && (i[t] = !0,
            ...
            onDOMWriteForElement(t = this.element.style) {
                ...
                for (let e = 0, s = this.cssAttributes.length; e < s; e++)
            ...
            handleStyleTransform(t = this.element.style) {
                ...
                if (e.z.isActive || e.rotationX.isActive || e.rotationY.isActive) {
                    ...
                    const i = e.x.current
                        , r = e.y.current
                        , n = e.z.current;
                    if (s[12] = s[0] * i + s[4] * r + s[8] * n + s[12],
                        s[13] = s[1] * i + s[5] * r + s[9] * n + s[13],
                        s[14] = s[2] * i + s[6] * r + s[10] * n + s[14],
                        s[15] = s[3] * i + s[7] * r + s[11] * n + s[15],
                    ...
                    1 === e.scale.current && 1 === e.scaleX.current && 1 === e.scaleY.current || E.scale(s, s, [e.scale.current, e.scale.current, 1]),
                        t.transform = "matrix3d(" + s[0] + "," + s[1] + "," + s[2] + "," + s[3] + "," + s[4] + "," + s[5] + "," + s[6] + "," + s[7] + "," + s[8] + "," + s[9] + "," + s[10] + "," + s[11] + "," + s[12] + "," + s[13] + "," + s[14] + "," + s[15] + ")"
                    ...
                    e.scaleX.isActive || e.scaleY.isActive ? (s[0] = s[0] * e.scaleX.current,
                        s[1] = s[1] * e.scaleX.current,
                        s[2] = s[2] * e.scaleY.current,
                        s[3] = s[3] * e.scaleY.current) : (s[0] = s[0] * e.scale.current,
                            s[1] = s[1] * e.scale.current,
                            s[2] = s[2] * e.scale.current,
                            s[3] = s[3] * e.scale.current),
                        t.transform = "matrix(" + s[0] + ", " + s[1] + ", " + s[2] + ", " + s[3] + ", " + s[4] + ", " + s[5] + ")"
                }
            }
            handleEventDispatch() {
                if (0 !== this.keyframesRequiringDispatch.length) {
                    for (let t = 0, e = this.keyframesRequiringDispatch.length; t < e; t++) {
                        ...
                        e.needsEventDispatch = !1,
                            ...
                            this.eventObject.pageMetrics = i.pageMetrics,
                ...
                for (let t = 0, e = this.attributes.length; t < e; t++) {
                    ...
                    if (!(s[0].keyframeType > i.KeyframeTypes.InterpolationForward))
                        for (let t = 0, i = s.length; t < i; t++) {
                            let r = s[t];
                            null === r.jsonProps[e][0] && (0 === t ? r.jsonProps[e][0] = r.animValues[e][0] = this.tweenProps[e].current : r.animValues[e][0] = s[t - 1].animValues[e][1]),
                                null === r.jsonProps[e][1] && (r.animValues[e][1] = t === i - 1 ? this.tweenProps[e].current : s[t + 1].animValues[e][0]),
            ...
            getBounds(t) {
                ...
                for (let e = 0, s = this.attributes.length; e < s; e++) {
                    ...
                    for (let e = 0; e < s.length; e++) {
                        let i = s[e];
                        this.boundsMin = Math.min(i.start, this.boundsMin),
                            this.boundsMax = Math.max(i.end, this.boundsMax),
                            t.min = Math.min(i.start, t.min),
                            t.max = Math.max(i.end, t.max)
                    }
                }
            }
            ...
            updateKeyframe(t, e) {
                t.parseOptions(e),
                    ...
                    this.group.keyframesDirty = !0,
                    p.update(() => {
                        this.trigger(i.EVENTS.ON_KEYFRAME_UPDATED, t),
                            this.group.trigger(i.EVENTS.ON_KEYFRAME_UPDATED, t)
                    }
                        , !0)
            }
            removeKeyframe(t) {
                return t.destroyed || t.controller !== this ? Promise.resolve(null) : (t.markedForRemoval = !0,
                    ...
                    new Promise(e => {
                        this.group.rafEmitter.executor.eventEmitter.once("before:draw", () => {
                            e(t),
                                t.destroy();
                            let s = this._allKeyframes.indexOf(t);
                            -1 !== s && this._allKeyframes.splice(s, 1)
                        }
                        )
                    }
                    ))
    ...
    , function (t, e, s) {
        ...
        const i = s(0)
            ...
            , a = function (t) {
                for (let e in t) {
                    let s = t[e];
                    if (-1 === i.KeyframeJSONReservedWords.indexOf(e) && Array.isArray(s))
                        return !0
                }
                return !1
            };
    ...
    , function (t, e, s) {
        ...
        function l(t) {
            ...
            const m = (p = c[1],
                d = c[2],
                [p[1] * d[2] - p[2] * d[1], p[2] * d[0] - p[0] * d[2], p[0] * d[1] - p[1] * d[0]]);
            var p, d;
            if (a(c[0], m) < 0)
                for (let t = 0; t < 3; t++)
                    s[t] *= -1,
            ...
            return e[0] = .5 * Math.sqrt(Math.max(1 + c[0][0] - c[1][1] - c[2][2], 0)),
                ...
                c[0][2] > c[2][0] && (e[1] = -e[1]),
                c[1][0] > c[0][1] && (e[2] = -e[2]),
                f = e[0] < .001 && e[0] >= 0 && e[1] < .001 && e[1] >= 0 ? [0, 0, r(180 * Math.atan2(c[0][1], c[0][0]) / Math.PI)] : function (t) {
                    const [e, s, n, o] = t
                        , a = e * e
                        , h = s * s
                        , l = n * n
    ...
    , function (t, e, s) {
        ...
        t.exports = class extends i {
            constructor(t, e, s, i, n, o, a) {
                super(r.parseExpression(null, t), e, s, i, n, o),
                    this.applyToStyle = a,
                    this.pathStrings = r.getPathStrings(t)
            }
            update(t, e, s) {
                if (t[0].length !== t[1].length)
                    throw new Error("Path length mismatch. Start/end paths must must contain the same number of points. Start value: \r " + r.reconstructPath(t[0], this.pathStrings));
    ...
    , function (t, e, s) {
        const { trim: i, getStringNumbers: r, getStringNonNumbers: n, reconstructStringWithNumbers: o } = s(56)
            , a = /^\s*?M[(-?\d)|\s]/
            , h = /^(inset|circle|ellipse|polygon|path)\(/
            , l = t => a.test(t)
            , u = t => h.test(t);
        t.exports = {
            install(t, e) {
        ...
        class h extends i {
            ...
            onPlayTimeUpdate() {
                ...
                if (this._repeats === h.REPEAT_FOREVER || this._repeats > 0) {
                    let t = !1;
                    !this._isReversed && s > this.boundsMax ? (s -= this.boundsMax,
                        t = !0) : this._isReversed && s < 0 && (s = this.boundsMax + s,
                            t = !0),
        ...
        t.exports = class extends i {
            ...
            addKeyframe(t, e) {
                ...
                e.start = (e.delay || 0) + this.position.localUnclamped,
                    ...
                    e.preserveState = !0,
                    e.snapAtCreation = !0,
                    t._animInfo && (s = t._animInfo.group,
                        i = t._animInfo.controller);
                let r = super.addKeyframe(t, e);
                return t._animInfo.group = s,
                    t._animInfo.controller = i,
                    [["onStart", "once"], ["onDraw", "on"]].forEach(([t, s]) => {
                        if (!e[t])
                            return;
                        let i = e[t];
            ...
            removeOverlappingProps(t) {
                ...
                for (let i = 0, r = s._allKeyframes.length; i < r; i++) {
                    ...
                    o.length !== n.length ? o.forEach(t => delete r.animValues[t]) : (r.markedForRemoval = !0,
            ...
            onTimeEmitterUpdate(t) {
                ...
                this.position.local = this.position.localUnclamped = i,
                    this.onTimeUpdate()
            }
            onTimeUpdate() {
    ...
    , function (t, e, s) {
        ...
        t.exports = class extends i {
            constructor(t) {
                super(t),
                    this.PAUSED_EXT_CLASS = "fam-gallery-ext-paused",
                    this.gallery = this.el,
                    this.marquee = this.gallery.querySelector(".fam-gallery-marquee"),
                    this.isReducedMotion = document.documentElement.classList.contains("reduced-motion"),
                    this.scrollGroup = this.gallery._animInfo.group,
                    this.timeGroup = this.marquee._animInfo.group,
                    this.marqueeKeyframe = null,
                    this.observers = []
            }
            mounted() {
                this._cloneItems(),
                    this._startMarquee(),
                    this._scrollPlayback(),
                    this._listenForTabChange(),
                    this._setupObservers()
            }
            _cloneItems() {
                this.marquee.querySelectorAll(".fam-gallery-item").forEach(t => {
                    const e = t.cloneNode(!0);
                    e.classList.add("fgi-clone"),
                        this.marquee.appendChild(e)
                }
                )
            }
            _startMarquee() {
            ...
            _scrollPlayback() {
                ...
                e.controller.on("famGalleryVisible:enter", e => {
                    if (this.gallery.classList.contains(this.PAUSED_EXT_CLASS) || (this.timeGroup.play(),
                        this.marquee.style.willChange = "transform",
                        this._startObserving()),
                        !t) {
                        this.gallery.querySelectorAll("[data-fam-lazy-image]").forEach(t => t.removeAttribute("data-fam-lazy-image")),
                            t = !0
                    }
                }
                ),
            ...
            _listenForTabChange() {
                document.addEventListener("visibilitychange", () => {
                    document.hidden || this.gallery.classList.contains(this.PAUSED_EXT_CLASS) || this.isReducedMotion || (this.timeGroup.play(),
                        this.marquee.style.willChange = "transform")
                }
                )
            }
            ...
            _setupObservers() {
                ...
                Array.from(this.marquee.querySelectorAll(".fam-gallery-link")).map(e => {
                    const s = this._debounce(t => {
                        t.forEach(t => {
                            t.isIntersecting ? (e.removeAttribute("aria-hidden"),
                                e.removeAttribute("tabindex")) : (e.setAttribute("aria-hidden", !0),
