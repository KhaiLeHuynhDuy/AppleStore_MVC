!function t(e, n, o) {
    ...
    1: [function (t, e, n) {
        "use strict";
        var o = t(3)("mask-image", "linear-gradient(#000, #fff)");
        e.exports = o
    }
        , {
        3: 3
    ...
    14: [function (t, e, n) {
        ...
        e.exports = function (t) {
            ...
            if ((t += "") in o)
                return o[t].dom;
            for (s = r(),
                n = (t = i(t)).charAt(0).toUpperCase() + t.substring(1),
                e = "filter" === t ? ["WebkitFilter", "filter"] : (t + " " + u.dom.join(n + " ") + n).split(" "),
                c = 0; c < e.length; c++)
                if (void 0 !== s.style[e[c]])
            ...
            return e += "",
                !!(t = o(t)) && (r(t, e) ? e : (n = i[t].css,
                    "" !== (e = (e = e.replace(c, (function (e) {
                        ...
                        if (i = e.replace(a, ""),
                            (c = n + ":" + i) in u)
                            return !1 === u[c] ? "" : e.replace(i, u[c]);
                        for (o = s.css.map((function (t) {
                            return t + e
                        }
                        )),
                            o = [e].concat(o),
    ...
    31: [function (t, e, n) {
        ...
        e.exports = function (t) {
            var e = {};
            return e.browser = i(r.browser, o.browser, t),
                e.os = i(r.os, o.os, t),
                e
        }
    }
    ...
    34: [function (t, e, n) {
        ...
        e.exports = function (t) {
            var e = function () {
                const t = o.os.ios && i && o.os.version.major < 9
                    , e = o.os.ios && u && o.os.version.major < 8
                    , n = o.os.android && o.os.version.major < 8;
                return !(t || e || n)
            ...
            t.addTests({
                ...
                "old-safari": o.browser.safari && o.browser.version.major <= 12,
                chrome: o.browser.chrome,
                firefox: o.browser.firefox,
                edge: o.browser.edge,
                iphone: (o.os.osx || o.os.ios) && !u && a,
                ipad: (o.os.osx || o.os.ios) && u && a,
                "old-macos": function () {
                    const t = o.os.osx
                        , e = "PushManager" in window;
                    return t && !e && !u && !a
                }()
            }),
                t.htmlClass()
